...
export class DiscoverService {
  ...
  private readonly researchFeedItems = [
      {
        ...
        summary:
          "Scores 83.2% on AIME 2025 math competition, outperforming prior reasoning-focused systems.",
        provider: "Google DeepMind",
        category: "Reasoning",
        publishedAt: "2026-03-26",
        overview:
          "Google DeepMind's Gemini 2.5 Pro set a new state-of-the-art across multiple reasoning benchmarks. The paper highlights stronger iterative thought refinement, better long-context reasoning, and improved math performance on multi-step tasks.",
        metrics: [
      ...
      },
      {
        ...
        summary:
          "Research reveals unexpected scaling dynamics when combining vision and language-heavy training.",
        provider: "MIT CSAIL",
        category: "Multimodal",
        publishedAt: "2026-03-22",
        overview:
          "A new multimodal scaling study suggests balanced vision-language curricula outperform pure token scaling after a certain threshold. The authors also report more robust transfer to grounded reasoning tasks.",
        metrics: [
      ...
      },
      {
        ...
        summary:
          "A new methodology reduces harmful outputs while preserving task performance on broad eval sets.",
        provider: "Anthropic",
        category: "Alignment",
        publishedAt: "2026-03-18",
        overview:
          "Anthropic's updated alignment process layers self-critique, policy rehearsal, and refusal calibration to reduce harmful outputs without shrinking model usefulness on common enterprise tasks.",
        metrics: [
      ...
      },
      {
        ...
        summary:
          "Meta introduces new open-weight systems with stronger image-text grounding and tool-use hooks.",
        provider: "Meta AI",
        category: "Open Weights",
        publishedAt: "2026-03-15",
        overview:
          "Meta's latest open-weight release focuses on native multimodal understanding, broader context support, and easier tool orchestration for agent builders who need self-hostable systems.",
        metrics: [
      ...
      },
      {
        ...
        summary:
          "New evaluation compares retrieval accuracy at extreme context windows across frontier labs.",
        provider: "Stanford NLP",
        category: "Efficiency",
        publishedAt: "2026-03-10",
        overview:
          "A long-context benchmark from Stanford NLP compares retrieval fidelity, citation precision, and reasoning consistency past the one-million-token mark. Most models showed uneven recall at the far end of the window.",
        metrics: [
      ...
      },
      {
        ...
        summary:
          "The latest release focuses on lower inference cost while preserving competitive benchmark quality.",
        provider: "DeepSeek",
        category: "Open Weights",
        publishedAt: "2026-03-05",
        overview:
          "DeepSeek's latest open-weight update reduces inference overhead and improves structured reasoning stability. The result is a more attractive profile for teams optimizing self-hosted copilots and internal research assistants.",
        metrics: [
  ...
  researchFeed(query?: ListResearchFeedQueryDto) {
    ...
    return this.researchFeedItems.filter(
