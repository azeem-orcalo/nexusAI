...
export declare class AgentsService {
    ...
    constructor(agentStore: MongooseModel<AgentDocument>, messageStore: MongooseModel<AgentMessageDocument>, taskStore: MongooseModel<AgentTaskDocument>);
    private mapAgent;
    private mapTask;
    ...
    createTask(agentId: string, payload: CreateAgentTaskDto): Promise<{
        id: string;
        agentId: string;
        name: string;
        completed: boolean;
